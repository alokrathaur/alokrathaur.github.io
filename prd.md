...
4. Highlighting **only four core flagship studio products**:
   ...
   - **DotMesh** (Mobile Strategy Game — iOS App Store & Web)
...
| **DotMesh** | Mobile Strategy Game (iOS & Web) | App Store & `https://alokrathaur.github.io/DotMesh-Pro/` | `/dotmesh.html` (and `/dotmesh/`) | Reimagined Dots & Boxes, 2-4P local multiplayer, smart AI bots, neon cyber visual themes. |
